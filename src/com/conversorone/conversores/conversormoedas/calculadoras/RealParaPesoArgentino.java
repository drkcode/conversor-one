...
public class RealParaPesoArgentino extends AbstractCalculadora {
    CotacaoVO cotacaoVO;

    public void inicializar ()  {
        try {
            cotacaoVO = new Cotacao("BRL", "ARS").get();
    ...
    public String calcular(double input) {
        ...
        return formatar(String.format("%.2f", total), "pesos argentinos");
    }
}
